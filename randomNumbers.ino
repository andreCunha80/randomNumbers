// https://www.youtube.com/watch?v=k_DZZLQqORw
...
const char* ssid         = "";// login gateway
const char* password     = "";// senha gateway
const char* mqttServer   = "demo.thingsboard.io";
const int   mqttPort     = 1883;
const char* mqttUser     = "";       //User name broker
const char* mqttPassword = "";        //Password broker
const char* mqttClient   = ""; //ID broker client
